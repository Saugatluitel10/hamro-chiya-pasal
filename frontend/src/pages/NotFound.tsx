  ...
  return (
    ...
    <main className="min-h-[60vh] grid place-items-center px-4 text-center">
      <div>
        ...
        <Link
          to={`/${locale}/`}
          className="inline-flex items-center justify-center rounded-md bg-[--color-primary] px-4 py-2 text-white font-medium hover:bg-[#6f1616] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--color-accent] focus-visible:ring-offset-2 ring-offset-white dark:focus-visible:ring-offset-gray-900"
        >
          {t('notfound.cta.home')}
        </Link>
      </div>
