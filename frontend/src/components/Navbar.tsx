        ...
        <div className="flex items-center gap-5">
          ...
          <div className="flex items-center gap-1 ml-2" aria-label={t('toggle.language')}>
            <button
              ...
              className={`text-xs px-2 py-1 rounded ${locale === 'ne' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-200' : 'text-gray-600 dark:text-gray-400 hover:text-emerald-600'}`}
            >
              {t('lang.ne')}
            </button>
            ...
            <button
              ...
              className={`text-xs px-2 py-1 rounded ${locale === 'en' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-200' : 'text-gray-600 dark:text-gray-400 hover:text-emerald-600'}`}
            >
              {t('lang.en')}
            </button>
          </div>
